                ...
                <div class="row">
                    <div class="col">
                        <h4 class="h5 align-middle m-0 font-weight-bold text-warning">
                            Form Tambah Barang Non ATK
                        </h4>
                    </div>
                    <div class="col-auto">
                        <a href="<?= base_url('barang/nonatk') ?>" class="btn btn-warning btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
                        ...
                        <div class="input-group">
                            <select name="jenis_id" id="jenis_id" class="selectpicker" data-live-search="true">
                                ...
                                <!-- <?php foreach ($jenis as $j) : ?>
                                    <option <?= set_select('jenis_id', $j['id_nonatk']) ?> value="<?= $j['id_nonatk'] ?>"><?= $j['jenis_atk'] ?></option>
                                <?php endforeach; ?> -->
                                <?php foreach ($jenis as $j) : ?>
                                    <option <?= $this->uri->segment(3) == $j['jenis_nonatk'] ? 'selected' : '';  ?> <?= set_select('jenis_id', $j['id_nonatk']) ?> value="<?= $j['id_nonatk'] ?>"><?= $j['kode_nonatk'] . ' | ' . $j['jenis_nonatk'] ?></option>
