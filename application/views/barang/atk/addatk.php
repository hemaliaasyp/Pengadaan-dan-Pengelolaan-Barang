                        ...
                        <div class="input-group">
                            <select name="jenis_id" id="jenis_id" class="selectpicker" data-live-search="true">
                                ...
                                <?php foreach ($jenis as $j) : ?>
                                    <option <?= $this->uri->segment(3) == $j['jenis_atk'] ? 'selected' : '';  ?> <?= set_select('jenis_id', $j['id_atk']) ?> value="<?= $j['id_atk'] ?>"><?= $j['kode_atk'] . ' | ' . $j['jenis_atk'] ?></option>
                                <?php endforeach; ?>
                            </select>
    ...
    $(document).ready(function() {
        ...
        $("#jenis_id").change(function() {
            ...
            for (let index = 0; index < count; index++) {
                if (jenis[index].id_atk == test) {
                    var kodejenis = jenis[index].kode_atk;
                }
...
<script>
    $(document).ready(function() {
        ...
        $("#jenis_id").change(function() {
            ...
            for (let index = 0; index < count; index++) {
                if (jenis[index].id_atk == test) {
                    var namajenis = jenis[index].jenis_atk;
                }
